...
import util.Piece._
import util.MatrixFenParser._


class MatrixFenParserSpec extends AnyWordSpec:
    /**
    ...
    "MatrixFenParser" should {
        ...
        "create a FEN representation of a given Matrix without the state" in {
            fenFromMatrix(new Matrix[Option[Piece]](8, None)) shouldBe "8/8/8/8/8/8/8/8"
            fenFromMatrix(new Matrix[Option[Piece]](2, None)) shouldBe "2/2"
